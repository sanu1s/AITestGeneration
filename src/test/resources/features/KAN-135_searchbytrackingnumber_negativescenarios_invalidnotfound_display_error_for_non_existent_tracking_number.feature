Feature: SearchByTrackingNumber_NegativeScenarios_InvalidNotFound
  ...
  Scenario: Display error for non-existent Tracking Number
    Given I am on the Order Search Page
    When I select "Tracking Number" from the search type dropdown
    And I enter "TRK000000000" into the "Tracking Number" field
    And I click the "Search" button
    Then the "error" section should be "visible"
    And the "error message" should display "No results for this Tracking Number"
