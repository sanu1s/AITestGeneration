...
public void theOrderStatusShouldBeAndDisplay(String status, String deliveryDateText) {
    System.out.println("Executing: The order status should be " + status + " and display " + deliveryDateText);
