...
public void theOrderStatusShouldBeAndDisplay(String expectedStatus, String deliveryDatePlaceholder) {
    System.out.println("Executing: The order status should be " + expectedStatus + " and display " + deliveryDatePlaceholder);
