...
@Then("The result should display a {string}")
public void theResultShouldDisplayADeliveryDate(String expectedText) {
    System.out.println("Executing: The result should display a " + expectedText);
